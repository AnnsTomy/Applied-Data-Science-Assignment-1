...
"""This code reads data from two Excel files and creates line, bar, and pie plots to visualize the data."""
...
"""creates a function for bar plot"""
...
def pie_plt(y, label): 
    ...
    Args:
        y: data of the year 2000 to be displayed as wedges in the pie chart.
        label: countries as labels to be applied to each wedge of the pie chart.
